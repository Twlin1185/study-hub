...
| **M37. 탐색 문서 일괄 도구(F60 — FB-25) → v2.02.1** | 다중 선택 + 선택 툴바(연결·이동·해제·소프트 삭제) · `POST /api/documents/bulk` 한 트랜잭션 · 문서 상세 [이동] · DDL 0 — 지시서 `stage-51-explore-bulk-select.plan.md` | 편성 2026-09-13 · **착수 전**(핵심 · v2.02.1 예정) |
