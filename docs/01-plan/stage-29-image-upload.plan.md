...
> 상태: **완료 — 자동 DoD 7/7 충족, 검토(opus) 조건부 통과 2026-08-14(치명 0·중요 0·경미 4). DoD 8(사용자 실사용 확인)과 baseline 갱신 승인만 대기** (작업 지시서 생성 2026-08-14. 착수 전 결정 ①~④ 전건 확정 2026-08-09 — 권고안대로. 새 결정 0 — 확정분을 계약으로 전개한 것이 이 문서다.
> 계약 정본 = 계획서 §14 F54 + **설계 §4.27 [S29]**(api) + screens §5.3(DocEditor 붙여넣기·드롭 — Design v1.33))
>
