...
| 문서 | 역할 |
|---|---|
| `docs/01-plan/study-app.plan.md` | 마스터 계획 — 기능 F01~F45, **스키마 DDL 단일 출처(§6.2)**, 로드맵 M1~M19(압축 표 + 진행·예정 F43~F45 상세), 리스크 R1~R22 |
...
| `docs/01-plan/stage-{1..17}-*.plan.md` | 단계별 작업 지시서 — 체크리스트·DoD·제외 범위. **stage 1~16 완료** · **17**(문서 상호참조·표현 UX F43) 착수 가능(게이트 없음) · **18**(해설·정답 보완 F44)·**19**(응용 모의고사 F45, M19)는 계획서 등재만(17↔18 순서 자유, 19는 F44 선행 권장). 각 단계의 완료 경위·게이트 기록은 해당 stage 문서 참조 |
