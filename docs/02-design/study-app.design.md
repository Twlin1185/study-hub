...
| `study-app.design.api.md` | §4 API 명세(4.1~4.23, [S1]~[S21] 단계 태그) — 백엔드 구현 시 해당 절만 부분 읽기 |
| `study-app.design.screens.md` | §5 화면 상세(13개 — 5.13 제안함은 S20 신설) · §6 테마 토큰 · §7 상태 관리 — 프론트 구현 시 해당 절만 부분 읽기 |
