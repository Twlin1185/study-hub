...
> 상위 문서: `docs/01-plan/study-app.plan.md` (Draft v0.29)
...
| `study-app.design.api.md` | §4 API 명세(4.1~4.20, [S1]~[S18] 단계 태그) — 백엔드 구현 시 해당 절만 부분 읽기 |
