...
| `docs/01-plan/editor-v2.plan.md` | **문서 작성·편집 재편(→ v2.00.0) 별지 계획서** — 전략·아키텍처·로드맵(M31~M36). **1차 확정(2026-08-15): D2 BlockNote 채택·D3 R32 재개·D9 드래프트 격리(노트 베타 → 검증 후 documents 탑재). D1·D4~D8 확정 대기 — 미확정 결정 관련 구현 착수 금지** |
