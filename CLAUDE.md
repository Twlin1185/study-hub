...
**N-2(구 편집기 퇴역 실행) = 실행 확정 · 단 순서는 맨 마지막**(2026-08-23 사용자 결정 — 잔여 수정이
**전건 완료된 뒤** v2.0.x 후속 stage로 편성. 그때까지 구 편집기·퇴로 토글 코드 **무접촉** 유지).
이후 작업(잔여 수정 · 캡처 파이프라인 · 백로그 FB-2/FB-6~FB-9 등)은 **v2.x 계획서를 먼저 확정한 뒤 착수** (관례).
