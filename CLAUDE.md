...
| `docs/01-plan/stage-{1..20}-*.plan.md` | 단계별 작업 지시서 — 체크리스트·DoD·제외 범위. **stage 1~19 완료**(17~19 잔여 사용자 확인 항목은 2026-08-02 사용자 확인으로 완료 처리 — 표본 수치 미기록) · **20**(반입 자기 개선 루프 F46, M20) **완료**(2026-08-02 검토 최종 통과 — DoD 자동 검증 6/6·치명 0·경미 7건 전건 해소(표적 재검토 통과), 사용자 이행 항목(DoD 7·8)은 2026-08-03 사용자 확인으로 완료 처리 — 표본 수치 미기록). 각 단계의 완료 경위·게이트 기록은 해당 stage 문서 참조 |
