...
**현재 버전 v1.90.1** (2026-08-15 — stage 1~30 전 단계 완료 시점). 다음 거대 프로젝트 =
**문서 작성·편집 기능 재편** → 완료 시 **v2.00.0** 출시 예정 (범위·로드맵은 계획서에 먼저 확정 후 착수).
...
| `docs/01-plan/editor-v2.plan.md` | **문서 작성·편집 재편(→ v2.00.0) 별지 계획서** — 전략·아키텍처·로드맵(M31~M36)·결정 D1~D10. **현황(2026-08-15): D3·D4·D5·D9·D10 확정 / D1·D2(BlockNote)는 M31 집중 분석·성능 검증 후 위임 판정 / D7·D8 대기. 저장소 public — GPL 의존 금지(D10), 미확정 결정 관련 구현 착수 금지** |
...
| `docs/01-plan/stage-{1..30}-*.plan.md` | 단계별 작업 지시서 — 체크리스트·DoD·제외 범위. **stage 1~30 전 단계 완료**(2026-08-15 — 사용자 이행 항목(실사용 확인)까지 전건 종료 = v1.90.1). 완료 경위·게이트 기록·잔여 항목은 **각 stage 문서**가 정본(15단계 이후는 머리말 "상태" 줄 + 말미 "완료 기록", 그 이전은 체크박스) — CLAUDE.md에 옮겨 적지 말 것 |
